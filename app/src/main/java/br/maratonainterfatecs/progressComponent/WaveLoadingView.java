package br.maratonainterfatecs.progressComponent;
        ...
        if (mWaveShader != null) {
            ...
            switch (mShapeType) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    mWavePaint.setTextSize(70);
                    canvas.drawText(mTextoExibicao, (getWidth() - mCenterTitlePaint.measureText(mTextoExibicao)) / 4,
                            getHeight() / 2 - ((mCenterTitlePaint.descent() + mCenterTitlePaint.ascent()) / 2), mWavePaint);
                    break;
            }
...
//        mWaveShader = null;
    ...
    public void setTextoExibicao(String textoExibicao) {
        mTextoExibicao = textoExibicao;
    }

    public String getTextoExibicao() {
        return mTextoExibicao;
    }
